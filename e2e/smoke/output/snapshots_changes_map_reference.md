<!-- Generated by e2e/smoke/enumerate_changes_map.py — do not edit by hand. -->

Captured against DuckDB `1.5.4` + DuckLake extension `d318a545` with `DATA_INLINING_ROW_LIMIT = 10`.

Run provenance: `captured_at=2026-07-11T15:15:03Z` · `git_sha=831839597326` · `platform=darwin-arm64`.
