...
- [ ] `bench/medium.yaml` workload descriptor — 5-minute CI run at medium load: 100 snapshots/min, 1 000 rows/snapshot, 5 consumers, mix of webhook + Kafka sinks. Longer soak runs and variable-load profiles stay out of the regular CI path until Phase 5.
