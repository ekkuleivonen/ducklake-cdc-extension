...
We as members, contributors, and maintainers of `ducklake-cdc` pledge
...
pull requests, code review comments, project chat channels — and
...
may be reported to the project maintainers via the contact route
listed in the project README. All complaints will be reviewed and
